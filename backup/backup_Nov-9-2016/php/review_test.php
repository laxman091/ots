  ...
  <table class="table table-striped" id='tbl' width="200">
	...
	?>
      <tr>
        ...
        <td><?php if($row[4] == 1 ) echo '<font color="green"><span class="glyphicon glyphicon-ok"></span> Correct</font>'; if($row[5] == 1) echo '<font color="red"><span class="glyphicon glyphicon-remove"></span> Wrong</font>'; ?></td>
