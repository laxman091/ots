...
<div class="container">
  ...
  <form id="question_form">
   ...
   <div class="panel panel-default height">
                        <div class="panel-heading">Select all Cateogory</div>
                        <div class="panel-body">
						<div>
						  <select class="selectpicker pull-left" id="cat_level" name="question_level">
...
<div>
 ...
 <div class="panel panel-default height">
                        <div class="panel-heading">Answer Cateogory</div>
                        <div class="panel-body">
