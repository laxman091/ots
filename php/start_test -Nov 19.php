...
$sql1 = "SELECT t1.id,t1.question FROM questions t1 JOIN category t2 ON t2.id = t1.category_id WHERE t1.category_id = '$cat_id' && t1.topics = '$ta' order by RAND() LIMIT 100 ";
