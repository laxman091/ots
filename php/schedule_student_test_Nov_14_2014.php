...
$(document).ready(function(){
	...
	//alert('a');
		...
		$('.chkb').click(function(){
			...
			var tst = $('#tsname').text();
			alert(strlevel+quest_cat+tst);
			//var url_to_load = "../php/update_question.php?id="+id1;
			//var url_to_load = "../php/show_topics.php?level="+strlevel+"&cat="+tst+"&testname="+quest_cat;
			//$('#showtopics').load('../php/show_topics.php?level='+strlevel+'&cat='+tst+'&testname='+quest_cat);
			$('#showtopics').load('../php/show_topics.php?level='+strlevel+'&cat='+quest_cat+'&testname='+tst);
                    ...
                    <div class="panel panel-default height">
						...
						<div class="panel-body">
                             ...
                             <div class="form-group" style="width:100px;">
							  ...
							  <select class="form-control" name="testlevel" id="testcategory" onchange="getLevel(this.value)">
						...
						?>
							 ...
							 <!--div class="form-group" style="margin-left:20px;"-->
							<div class="checkbox">
							  <label><input type="checkbox" value="<?php echo strtolower($row->id);?>" name="testlevel[]" class="chkb"><span id="tsname"><?php echo strtoupper($row->category_name); ?></span></label>
							</div>
							<?php } ?>
							<!--div class="checkbox">
                            ...
                            <thead>
								...
								<tr>
									...
									<div class="form-group">
										<input type="date" name="startdate" id="startdate" class="datepicker1" value=""/><input type="time" name="starttime" id="starttime" value=""/><span class="glyphicon glyphicon-calendar pull-center"></span>
