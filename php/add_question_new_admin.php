...
$(document).ready(function(){
	...
	//console.log(chk);
	var optionarr = new Array( "A", "B", "C","D","E","F","G","H","I","J");
	...
	$('.addquest').click(function(){
		...
		var data = $("form").serialize();
			...
			//$('form').reset();
			//$('#response_here').empty();
			$('#response_here').load('../php/add_question_new_admin.php');
			});
	});
});
</script>
...
.field_wrapper div{margin-top:10px; margin-bottom:10px;}
...
<select class="selectpicker pull-center" id="question_cat" name="category">
  ...
  ?>
					...
					<div class="col-sm-4 col-md-6">
											...
											<textarea class="form-control" rows="4" cols="150" name="question" id="question"></textarea>     
										   </div>
												<div>
